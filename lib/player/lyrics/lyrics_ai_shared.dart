...
final class LyricsAiPromptBuilder {
  ...
  static String buildConvertToKaraokePrompt({
    ...
    return '这是这首歌的歌词和音频，请将歌词转换为卡拉OK逐字时间轴格式（word-by-word LRC / Enhanced LRC）。\n'
        ...
        '6. 【空格规范】：中文、日文、韩文等非英文歌词，字与字之间、字与时间戳之间严禁添加任何空格（例如必须输出 [00:14.39]繋[00:14.65]い[00:15.00]だ，严禁输出 [00:14.39] 繋[00:14.65] い 或 [00:14.39]繋 [00:14.65]い 等多余空格格式）！对于歌词中的英文单词，单词与单词之间必须保留正常空格。\n'
