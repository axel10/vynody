...
@useResult
$Res call({
 int? id, int? mediaId, String path, String title, String album, String artist, int? duration, String? artworkPath, String? thumbnailPath, int? artworkWidth, int? artworkHeight, int? trackNumber, int? sourceFlags, Uint8List? themeColorsBlob, Uint8List? waveformBlob, int? lastModifiedTime, int? metadataTextScanned, int? metadataImgScanned, int? createdAt, int? deletedAt, List<String>? genres, bool isAppModified
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int? mediaId,  String path,  String title,  String album,  String artist,  int? duration,  String? artworkPath,  String? thumbnailPath,  int? artworkWidth,  int? artworkHeight,  int? trackNumber,  int? sourceFlags,  Uint8List? themeColorsBlob,  Uint8List? waveformBlob,  int? lastModifiedTime,  int? metadataTextScanned,  int? metadataImgScanned,  int? createdAt,  int? deletedAt,  List<String>? genres,  bool isAppModified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SongMetadata() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int? mediaId,  String path,  String title,  String album,  String artist,  int? duration,  String? artworkPath,  String? thumbnailPath,  int? artworkWidth,  int? artworkHeight,  int? trackNumber,  int? sourceFlags,  Uint8List? themeColorsBlob,  Uint8List? waveformBlob,  int? lastModifiedTime,  int? metadataTextScanned,  int? metadataImgScanned,  int? createdAt,  int? deletedAt,  List<String>? genres,  bool isAppModified)  $default,) {final _that = this;
switch (_that) {
case _SongMetadata():
return $default(_that.id,_that.mediaId,_that.path,_that.title,_that.album,_that.artist,_that.duration,_that.artworkPath,_that.thumbnailPath,_that.artworkWidth,_that.artworkHeight,_that.trackNumber,_that.sourceFlags,_that.themeColorsBlob,_that.waveformBlob,_that.lastModifiedTime,_that.metadataTextScanned,_that.metadataImgScanned,_that.createdAt,_that.deletedAt,_that.genres,_that.isAppModified);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int? mediaId,  String path,  String title,  String album,  String artist,  int? duration,  String? artworkPath,  String? thumbnailPath,  int? artworkWidth,  int? artworkHeight,  int? trackNumber,  int? sourceFlags,  Uint8List? themeColorsBlob,  Uint8List? waveformBlob,  int? lastModifiedTime,  int? metadataTextScanned,  int? metadataImgScanned,  int? createdAt,  int? deletedAt,  List<String>? genres,  bool isAppModified)?  $default,) {final _that = this;
switch (_that) {
case _SongMetadata() when $default != null:
return $default(_that.id,_that.mediaId,_that.path,_that.title,_that.album,_that.artist,_that.duration,_that.artworkPath,_that.thumbnailPath,_that.artworkWidth,_that.artworkHeight,_that.trackNumber,_that.sourceFlags,_that.themeColorsBlob,_that.waveformBlob,_that.lastModifiedTime,_that.metadataTextScanned,_that.metadataImgScanned,_that.createdAt,_that.deletedAt,_that.genres,_that.isAppModified);case _:
  return null;
