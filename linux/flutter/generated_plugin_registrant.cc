...
#include <flutter_desktop_lyrics/flutter_desktop_lyrics_plugin.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) flutter_desktop_lyrics_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "FlutterDesktopLyricsPlugin");
  flutter_desktop_lyrics_plugin_register_with_registrar(flutter_desktop_lyrics_registrar);
